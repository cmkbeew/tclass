...
@WebServlet("/message/sendDetail.do")
public class SendDetailController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(messageIdx > 0) {
			...
			req.getRequestDispatcher("./sendDetail.jsp?messageIdx=" + messageIdx).forward(req, resp);
		} else {
